...
namespace Altv_Roleplay.Handler
{
        ...
        terHandler : IScript
    {
        ...
        public async Task RegisterNewPlayer(ClassicPlayer player, string username, string email, string pass, string passrepeat)
        {
            if (player == null || !player.Exists || player.IsBlocked || player.isSpawned) return;
