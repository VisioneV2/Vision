...
namespace Altv_Roleplay.Handler
{
    class WeaponHandler : IScript
    {
            ...
            try
            {
                ...
                switch (wName)
                {
                    ...
                    case "Machete":
                        ...
                        break;
                    case "Zerbrochene Glasflasche":
                        wType = "Fist";
                        normalWName = "Zerbrochene Glasflasche";
                        wHash = (WeaponModel)0xF9E6AA4B;
                        break;
                    case "Klappmesser":
                        wType = "Fist";
                    ...
                    case "Feuerlöscher":
                        ...
                        break;
                    case "Spezialkarabiner":
                    case "Spezialkarabiner Munition":
                        wType = "Primary";
                        normalWName = "Spezialkarabiner";
                        ammoWName = "Spezialkarabiner";
                        wHash = WeaponModel.SpecialCarbine;
                        break;
                    case "Advanced Rifle":
                    case "Advanced Rifle Munition":
                        wType = "Primary";
                        normalWName = "Advanced Rifle";
                        ammoWName = "Advanced Rifle";
                        wHash = WeaponModel.AdvancedRifle;
                        break;
                    case "Marksman Rifle":
                    case "Marksman Rifle Munition":
                        wType = "Primary";
                        normalWName = "Marksman Rifle";
                        ammoWName = "Marksman Rifle";
                        wHash = WeaponModel.MarksmanRifle;
                        break;
                }
        ...
        public static string GetWeaponItemNameByWeaponModel(WeaponModel model)
        {
            string item_name = "";
            switch (model)
            {
                case WeaponModel.Pistol: item_name = "Pistole"; break;
                case WeaponModel.CombatPistol: item_name = "Gefechtspistole"; break;
                case WeaponModel.StunGun: item_name = "Tazer"; break;
                case WeaponModel.CombatPDW: item_name = "PDW"; break;
                case WeaponModel.SMG: item_name = "SMG"; break;
                case WeaponModel.Nightstick: item_name = "Schlagstock"; break;
                case WeaponModel.Knife: item_name = "Messer"; break;
                case WeaponModel.Crowbar: item_name = "Brecheisen"; break;
                case WeaponModel.BaseballBat: item_name = "Baseballschlaeger"; break;
                case WeaponModel.AntiqueCavalryDagger: item_name = "Dolch"; break;
                case WeaponModel.Hammer: item_name = "Hammer"; break;
                case WeaponModel.Hatchet: item_name = "Axt"; break;
                case WeaponModel.Machete: item_name = "Machete"; break;
                case WeaponModel.Switchblade: item_name = "Klappmesser"; break;
                case WeaponModel.FireExtinguisher: item_name = "Feuerlöscher"; break;
                case WeaponModel.Flashlight: item_name = "Taschenlampe"; break;
                case WeaponModel.MiniSMG: item_name = "MiniMP"; break;
                case WeaponModel.GusenbergSweeper: item_name = "Gusenberg"; break;
                case WeaponModel.BullpupRifle: item_name = "Bullpup"; break;
                case WeaponModel.DoubleBarrelShotgun: item_name = "Doppelschrotflinte"; break;
                case WeaponModel.CompactRifle: item_name = "MiniAK"; break;
                case WeaponModel.SniperRifle: item_name = "Sniper"; break;
                case WeaponModel.HeavyRevolver: item_name = "Revolver"; break;
                case WeaponModel.MarksmanRifle: item_name = "Marksman Rifle"; break;
                case WeaponModel.SpecialCarbine: item_name = "Spezialkarabiner"; break;
                case WeaponModel.AdvancedRifle: item_name = "Advanced Rifle"; break;
                case WeaponModel.PoolCue: item_name = "Queue"; break;
                case WeaponModel.GolfClub: item_name = "Golfschlaeger"; break;
                case WeaponModel.BrassKnuckles: item_name = "Schlagring"; break;
                case WeaponModel.BattleAxe: item_name = "Streitaxt"; break;
                case WeaponModel.BrokenBottle: item_name = "Zerbrochene Glasflasche"; break;
            }

            return item_name;
        }

        public static bool IsMeleeKill(WeaponModel model)
        {
            switch ($"{model}")
            {
                case "3452007600": return true; // WEAPON_FALL
                case "910830060": return true; // WEAPON_EXHAUSTION
                case "3425972830": return true; // WEAPON_HIT_BY_WATER_CANNON 
                case "133987706": return true; // WEAPON_RAMMED_BY_CAR 
                case "2741846334": return true; // WEAPON_RUN_OVER_BY_CAR
                case "341774354": return true; // WEAPON_HELI_CRASH 
                case "3750660587": return true; // WEAPON_FIRE
                case "4284007675": return true; // WEAPON_DROWNING
                case "1936677264": return true; // WEAPON_DROWNING_IN_VEHICLE
                case "539292904": return true; // WEAPON_EXPLOSION 
                case "2461879995": return true; // WEAPON_ELECTRIC_FENCE
                case "2339582971": return true; // WEAPON_BLEEDING
                case "1741783703": return true; // VEHICLE_WEAPON_WATER_CANNON
                case "2725352035": return true; // WEAPON_UNARMED
                case "2971687502": return true; // VEHICLE_WEAPON_ROTORS
                case "1945616459": return true; // VEHICLE_WEAPON_TANK
        ...
        public static WeaponModel GetWeaponModelByName(string wName)
        {
            ...
            switch (wName)
            {
                ...
                case "Marksman Rifle": wHash = WeaponModel.MarksmanRifle; break;
                case "Spezialkarabiner": wHash = WeaponModel.SpecialCarbine; break;
                case "Advanced Rifle": wHash = WeaponModel.AdvancedRifle; break;
                case "Queue": wHash = WeaponModel.PoolCue; break;
                case "Golfschlaeger": wHash = WeaponModel.GolfClub; break;
                case "Schlagring": wHash = WeaponModel.BrassKnuckles; break;
                case "Streitaxt": wHash = WeaponModel.BattleAxe; break;
                case "Zerbrochene Glasflasche": wHash = WeaponModel.BrokenBottle; break;
            }
            return wHash;
        }
