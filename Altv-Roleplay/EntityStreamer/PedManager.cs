...
namespace Altv_Roleplay.EntityStreamer
{
    public class Ped : Entity, IEntity
    {
        ...
        public Vector3 Rotation
        {
            ...
            set
            {
#pragma warning disable CS8073 // Das Ergebnis des Ausdrucks lautet immer gleich, da ein Wert dieses Typs niemals 'null' entspricht
                if (Rotation != null && Rotation.X == value.X && Rotation.Y == value.Y && Rotation.Z == value.Z && value != new Vector3(0, 0, 0))
#pragma warning restore CS8073 // Das Ergebnis des Ausdrucks lautet immer gleich, da ein Wert dieses Typs niemals 'null' entspricht
                    return;
