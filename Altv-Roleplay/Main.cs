...
namespace Altv_Roleplay
{
    public class Main : AsyncResource
    {
        ...
        public override void OnStart()
        {
            ...
            //Alt.OnClient<IPlayer, string, string>("Server:Charselector:
            //
            //Char", Handler.LoginHandler.CharacterSelectedSpawnPlace);
            ...
            */
            ...
            EventSpamTimer.Elapsed += new ElapsedEventHandler(AntiCheatHandler.EventSpamHandler);
            //Interval
