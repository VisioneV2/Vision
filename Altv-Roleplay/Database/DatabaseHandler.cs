...
namespace Altv_Roleplay.Database
{
    internal class DatabaseHandler
    {
        ...
        internal static void LoadAllCharacterPhoneChats()
        {
            try
            {
                using (var db = new gtaContext())
                {
                    ...
                    Alt.Log($"{CharactersPhone.CharactersPhoneContacts_.Count} Character-Phone-Verlauf wurden geladen.");
        ...
        internal static void LoadAllServerFactions()
        {
            try
            {
                using (var db = new gtaContext())
                {
                    ...
                    ServerFactions.ServerFactionWaffenLaborItems_ = new List<Server_Faction_Waffen_Labor_Items>(db.Server_Faction_Waffen_Labor_Items);
                    ...
                    Alt.Log($"{ServerFactions.ServerFactionWaffenLaborItems_.Count} Server-Faction-Waffen-Labor-Items wurden geladen.");
                ...
                {
                    if (faction.laborPos != new Position(0, 0, 0)) EntityStreamer.HelpTextStreamer.Create("Drücke E um das Labor zu Betreten und U um es zu öffnen / schließen.", faction.laborPos, streamRange: 2);

                    if (faction.fraktionslagerPos != new Position(0, 0, 0)) EntityStreamer.HelpTextStreamer.Create("Drücke E um das Fraktionslager zu betreten und U um es zu öffnen / schließen.", faction.fraktionslagerPos, streamRange: 2);
                    if (faction.waffenlaborPos != new Position(0, 0, 0)) EntityStreamer.HelpTextStreamer.Create("Drücke E um das Waffen Labor zu betreten und U um es zu öffnen / schließen.", faction.waffenlaborPos, streamRange: 2);
                ...
                using (var db = new gtaContext())
                {
                    ...
                    foreach (var garage in ServerGarages.ServerGarages_)
                    {
                        if (garage.isBlipVisible)
                        {
                            ...
                            switch (garage.type)
                            {
                                case 0: garageType = "PKW-Garage"; garageSprite = 473; garageColor = 3; break;
                                ...
                                case 4: garageType = "LKW-Garage"; garageSprite = 360; garageColor = 77; break;
                            }
        ...
        internal static Task RenewAll()
        {
            ResetDatabaseOnlineState();
            LoadAllPlayers();
            LoadAllPlayerCharacters();
            LoadAllCharacterSkins();
            LoadAllCharacterBankAccounts();
            LoadAllCharacterLastPositions();
            LoadAllCharacterInventorys();
            LoadAllCharacterLicenses();
            LoadAllCharacterPermissions();
            LoadAllCharacterMinijobData();
            LoadAllCharacterPhoneChats();
            LoadAllServerStorages();
            LoadAllCharacterWanteds();
            LoadAllServerBlips();
            LoadAllServerMarkers();
            LoadAllServerVehiclesGlobal();
            LoadAllServerAnimations();
            LoadAllServerATMs();
            LoadAllServerBanks();
            LoadAllServerBankPapers();
            LoadAllServerItems();
            LoadAllServerPeds();
            LoadAllClothesShops();
            LoadAllServerShops();
            LoadAllServerShopItems();
            LoadAllServerBarbers();
            LoadAllServerTeleports();
            LoadAllGarages();
            LoadAllGarageSlots();
            LoadAllVehicleMods();
            LoadAllVehicles();
            LoadAllVehicleTrunkItems();
            LoadAllVehicleShops();
            LoadAllVehicleShopItems();
            LoadAllServerFarmingSpots();
            LoadAllServerFarmingProducers();
            LoadAllServerJobs();
            LoadAllServerLicenses();
            LoadAllServerFuelStations();
            LoadALlServerFuelStationSpots();
            LoadAllServerTabletAppData();
            LoadAllCharactersTabletApps();
            LoadAllCharactersTabletTutorialEntrys();
            LoadAllServerTabletEvents();
            LoadAllServerTabletNotes();
            LoadAllServerCompanys();
            LoadAllServerCompanyMember();
            LoadAllServerFactions();
            LoadAllServerFactionRanks();
            LoadAllServerFactionMembers();
            LoadAllServerFactionStorageItems();
            LoadAllServerDoors();
            LoadAllServerHotels();
            LoadAllServerHouses();
            LoadAllServerMinijobBusdriverRoutes();
            LoadAllServerMinijobBusdriverRouteSpots();
            LoadAllServerMinijobGarbageSpots();
            LoadAllServerLogsFaction();
            LoadAllServerLogsCompany();
            LoadAllTattooStuff();
