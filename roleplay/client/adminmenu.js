...
export default class NoClip {
    ...
    static keyHandler() {
        ...
        if (!isVectorEqual(new alt.Vector3(currentPos.x, currentPos.y, currentPos.z + zModifier), alt.Player.local.pos)) game.setEntityCoords(alt.Player.local.scriptID, currentPos.x, currentPos.y, (currentPos.z + zModifier - 1), true, true, true, true);
    }
}